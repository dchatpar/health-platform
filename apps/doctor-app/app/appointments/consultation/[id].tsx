...
export default function ConsultationScreen() {
  ...
  const { localStream, remoteStream, isConnected, toggleCamera, toggleMicrophone, switchCamera } =
    useWebRTC();
  ...
  const { setActiveConsultation, endConsultation, notes, setNotes, isEditingNotes } =
    consultationStore();

  // Set active consultation on mount
  useEffect(() => {
    if (id) {
  ...
  const saveNotes = async () => {
    // In production, save notes to backend
