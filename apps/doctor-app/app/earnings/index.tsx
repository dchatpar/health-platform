...
export default function EarningsIndexScreen() {
  ...
  return (
    ...
    >
      ...
      <View className="flex-row gap-3 mb-6">
        ...
        >
          <Text className="text-2xl mb-2">📊</Text>
          <Text className="text-sm font-medium text-gray-700">Export Report</Text>
        </TouchableOpacity>
      </View>
...
function Alert.alert(title: string, message: string) {
